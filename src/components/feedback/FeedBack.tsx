...
import { useCreateFeedBackMutation } from "@/redux/api/features/feedBackApi";
import { message } from "antd";

const FeedBack = () => {
  const [createFeedback, { isLoading, isSuccess }] =
    useCreateFeedBackMutation(undefined);

  const feedbackOnSubmit = async (data: any) => {
    message.loading("Thanks for your feedback");
    const feedbackData = {
  ...
  return (
    <>
      <section className="bg-white px-5 py-20 lg:py-[120px] overflow-hidden relative z-10">
          ...
          <div className="flex flex-wrap -mx-4 lg:justify-between">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-5/12">
              <div className="relative p-8 bg-white rounded-lg shadow-lg sm:p-12">
                <Form submitHandler={feedbackOnSubmit}>
                  <FormInput size="large" name="userName" label="User Name" />
